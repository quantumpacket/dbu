...
* [subversion](https://packages.debian.org/stretch/subversion) `1.9.5-1+deb9u2` - Advanced version control system
...
* [devscripts](https://packages.debian.org/stretch/devscripts) `2.17.6+deb9u2` - scripts to make the life of a Debian Package maintainer easier
